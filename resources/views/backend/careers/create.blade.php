...
@section('title', 'Create New Career')

@section('content')
<div class="max-w-4xl mx-auto">
    <!-- Page Title and Subtitle (Outside the card) -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Create New Career</h1>
        <p class="text-sm text-gray-600">Add a new career opportunity to attract talented candidates.</p>
    </div>

    <!-- Form Card -->
    <form method="POST" action="{{ route('admin.careers.store') }}" class="bg-white rounded-lg shadow-md">
        @csrf
        ...
        <div class="p-6 border-t border-gray-200 flex items-center justify-between bg-gray-50">
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    <i class="fas fa-plus mr-2"></i>Create Career
                </button>
            </div>
        </div>
    </form>
