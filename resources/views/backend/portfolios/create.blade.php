...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Create New Portfolio</h1>
        <p class="text-sm text-gray-600">Add a new portfolio item to showcase your projects and work.</p>
    </div>

    <!-- Form Card -->
    <form method="POST" action="{{ route('admin.portfolios.store') }}" class="bg-white rounded-lg shadow-md">
        @csrf
